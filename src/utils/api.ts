...
const mockCountries: Country[] = [
  {
    ...
    landmarks: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1559628233-100c798642d3?w=400",
      ...
      },
      {
        ...
        coordinates: { lat: 39.647, lng: 66.976 },
        type: "historical",
        city: "Samarkand",
      },
    ],
  },
  {
    ...
    landmarks: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1505832018823-50331d49d2d1?w=400",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1611667214289-5c1a8f3c5c2f?w=400",
  ...
  },
  {
    ...
    landmarks: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1566479179817-7a1f0e8b7e2e?w=400",
    ...
    landmarks: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1552832230-c0197dd311b3?w=400",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1555401263-467d61afdb78?w=400",
  ...
  },
  {
    ...
    landmarks: [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1548919175-b36508a0b3f3?w=400",
    ...
    landmarks: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1539650116574-75d0279bd8bf?w=400",
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1554224154-260325c05993?w=400",
...
export const countryApi = {
  ...
  getStatistics: async (): Promise<Statistics> => {
    ...
    const totalPopulation = mockCountries.reduce(
    ...
    const mostPopulated = mockCountries.reduce(
      (max, c) => (c.population > max.population ? c : max),
      mockCountries[0],
    );
    const largestArea = mockCountries.reduce(
      (max, c) => (c.area > max.area ? c : max),
      mockCountries[0],
    );
    const smallestArea = mockCountries.reduce(
      (min, c) => (c.area < min.area ? c : min),
      mockCountries[0],
    );
    ...
    mockCountries.forEach((country) => {
      languagesCount[country.language] =
        (languagesCount[country.language] || 0) + 1;
      if (country.region) {
